        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 items-end">
          ...
          <div className="w-full">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-teal-200 rounded-xl text-sm sm:min-w-[200px] bg-white"
            >
              ...
              <tbody className="divide-y divide-slate-100">
                {teachers.map((teacher) => (
                  <tr key={teacher.id} className="hover:bg-slate-50/50 transition">
                    <td data-label="Name" className="px-6 py-4 font-medium text-slate-900">{teacher.name || "—"}</td>
                    <td data-label="Email" className="px-6 py-4 text-slate-700 break-all">{teacher.email}</td>
                    <td data-label="Courses / Subjects" className="px-6 py-4 text-slate-700">
                    ...
                    <td data-label="Joined" className="px-6 py-4 text-slate-600">
