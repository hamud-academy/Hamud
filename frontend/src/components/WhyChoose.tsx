...
export default function WhyChoose() {
  ...
  const features: { titleKey: TranslationKey; descKey: TranslationKey; icon: React.ReactNode }[] = [
    {
      titleKey: "landing.whyMentorsTitle",
      descKey: "landing.whyMentorsDesc",
      icon: (
    ...
    {
      titleKey: "landing.whyCertifiedTitle",
      descKey: "landing.whyCertifiedDesc",
      icon: (
        <svg className="w-7 h-7 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      titleKey: "landing.whyFlexibleTitle",
      descKey: "landing.whyFlexibleDesc",
      icon: (
        <svg className="w-7 h-7 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
