...
const icons = {
  ...
  teachers: "M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824 2.998 12.078 12.078 0 01.665-6.479L12 14z",
  ...
  footer: "M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5z M8 17h8 M8 13h8 M8 7h8",
  about: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
  settings: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z",
};

const mainNav: { href: string; labelKey: TranslationKey; icon: string }[] = [
  { href: "/admin", labelKey: "nav.dashboard", icon: icons.dashboard },
  { href: "/admin/requests", labelKey: "nav.requests", icon: icons.requests },
  { href: "/admin/courses", labelKey: "nav.courses", icon: icons.courses },
  { href: "/admin/diplomas", labelKey: "nav.diploma", icon: icons.courses },
  { href: "/admin/students", labelKey: "nav.students", icon: icons.students },
  { href: "/admin/teachers", labelKey: "nav.teachers", icon: icons.teachers },
];

const configNav: { href: string; labelKey: TranslationKey; icon: string }[] = [
  { href: "/admin/accounts", labelKey: "admin.createAccounts", icon: icons.createAccount },
  { href: "/admin/system-config", labelKey: "admin.systemConfig", icon: icons.systemConfig },
  { href: "/admin/contact-config", labelKey: "admin.contactConfig", icon: icons.contact },
  { href: "/admin/footer-config", labelKey: "admin.footerConfig", icon: icons.footer },
  { href: "/admin/about-config", labelKey: "admin.aboutConfig", icon: icons.about },
  { href: "/admin/settings", labelKey: "admin.settings", icon: icons.settings },
];
            ...
            <div key={item.href}>
              ...
              {showSystemConfigChildren && (
                <div className="ml-4 mt-0.5 pl-4 border-l border-slate-200 dark:border-slate-700 space-y-0.5">
                  {[
                    { href: "/admin/categories", labelKey: "admin.popularCategories" as TranslationKey },
                    { href: "/admin/system-config/logo", labelKey: "admin.changeLogo" as TranslationKey },
                    { href: "/admin/system-config/name", labelKey: "admin.changeName" as TranslationKey },
                    { href: "/admin/system-config/fav-icon", labelKey: "admin.favIcon" as TranslationKey },
                    { href: "/admin/system-config/hero-photo", labelKey: "admin.changeHeroPhoto" as TranslationKey },
                    { href: "/admin/system-config/texts", labelKey: "admin.changeTexts" as TranslationKey },
                    { href: "/admin/system-config/live-lessons-image", labelKey: "admin.liveLessons" as TranslationKey },
                    { href: "/admin/system-config/partner-logos", labelKey: "admin.partnerLogos" as TranslationKey },
                    { href: "/admin/system-config/payment-numbers", labelKey: "admin.paymentNumbers" as TranslationKey },
                  ].map((child) => (
                    <Link
                      key={child.href}
                      href={child.href}
